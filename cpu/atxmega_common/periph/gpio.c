                  ...
                  gpio_cb_t cb, void *arg)
{
    ...
    *(&(port->PIN0CTRL) + (1 << pin_num)) = (flank & 0x0f);
    ...
    /* Clear Interrupt 0 flag to avoid false positiv */
    port->INTFLAGS = 1;
...
{
    /* RF_IRQ    - PD2 */
    DEBUG("gpio_irq_enable pin = 0x%02x \n", pin );
