 ...
 */
#define CALIBRATION_FREQUENCY 8000000U

/*! Frequency of the external oscillator. A 32kHz crystal is recommended
 */
#define XTAL_FREQUENCY 32768U
#define EXTERNAL_TICKS 50U               // ticks on XTAL. Modify to increase/decrease accuracy
...
#define RUNNING 0
#define FINISHED 1
#define DEFAULT_OSCCAL_MASK        0x08  // Lower half and
