...
/**
 * @defgroup    boards_pinoccio-mega256rfr2 Pinoccio - Mega256rfr2
 * @ingroup     boards
 * @brief       Board specific files for the Pinoccio Mega 256rfr2 board.
 * @{
 *
 * @file
 * @brief       Board specific definitions for the Pinoccio Mega 256rfr2 board.
 *
...
#define UART_STDIO_BAUDRATE (9600U)       /**< Sets Baudrate for e.g. Shell */
#endif
/** @} */
...
#define LED0_PIN            GPIO_PIN(1, 4) /* BLUE  */
#define LED1_PIN            GPIO_PIN(1, 5) /* RED   */
#define LED2_PIN            GPIO_PIN(1, 6) /* GREEN */

#define LED0_MASK           (1 << DDB4)
#define LED1_MASK           (1 << DDB5)
#define LED2_MASK           (1 << DDB6)
